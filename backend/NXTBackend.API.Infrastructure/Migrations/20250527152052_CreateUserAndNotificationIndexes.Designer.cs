...
namespace NXTBackend.API.Infrastructure.Migrations
{
    ...
    [Migration("20250527152052_CreateUserAndNotificationIndexes")]
    partial class CreateUserAndNotificationIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NXTBackend.API.Domain.Entities.Notification", b =>
                {
                    ...
                    b.HasIndex("NotifiableId", "Descriptor")
                        .HasDatabaseName("IX_notifications_notifiable_descriptor");
                    ...
                    b.HasIndex("State", "CreatedAt")
                        .HasDatabaseName("IX_notifications_state_created")
                        .HasFilter("read_at IS NOT NULL OR state != 0");
            ...
            modelBuilder.Entity("NXTBackend.API.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasIndex("CreatedAt")
                        .IsDescending()
                        .HasDatabaseName("IX_user_list_covering");
                    ...
                    b.HasIndex("UpdatedAt")
                        .IsDescending()
                        .HasDatabaseName("IX_user_updated_at");

                    b.HasIndex("UserFeedId")
                        .IsUnique()
                        .HasDatabaseName("IX_user_feed_id")
                        .HasFilter("user_feed_id IS NOT NULL");

                    b.HasIndex("Login", "DisplayName")
                        .HasDatabaseName("IX_user_login_display");

                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("Login", "DisplayName"), new[] { "AvatarUrl", "CreatedAt" });

                    b.HasIndex("UpdatedAt", "CreatedAt")
                        .IsDescending()
                        .HasDatabaseName("IX_user_activity");

...
<Base variant="center-navbar">
	...
	{#snippet right()}
		<div class="flex flex-col gap-2 rounded border p-4">
			...
			<div class="flex max-h-96 flex-wrap gap-4 overflow-auto border p-3">
				<Button onclick={() => (projects = fetch("/projects"))} />
				{#if projects}
					{#await projects}
						<p>Loading...</p>
					{:then project}
				...
				{/if}
				<!-- <Taskcard
					href="/users/Lmwfa1HEQt6jhU0BbzW5zQ/projects/1"
					type="project"
					title="Project!"
				/> -->
				<!-- <Taskcard

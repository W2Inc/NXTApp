...
<!-- TODO: This might be weird but trying to show the next page url is actually broken -->
<!-- Like, it will double it instead and be completely wrong -->
<!-- A solution would be that after navigation we get the page param but ehhhhh -->
